...
\begin{frame}{What should go in the box?}
   ...
   \begin{columns}
      \begin{column}{0.5\textwidth}
         ...
         \onslide<6->{For a black box, we need...}
         \begin{itemize}[<+(7)->]
            \item automated start-to-finish calculations
            \item minimal human input
         \end{itemize}
      \end{column}
      \begin{column}{0.5\textwidth}
         \onslide<5->{\includegraphics[width=\columnwidth]{figures/black_box_filled_square.png}}
      \end{column}
   \end{columns}
\end{frame}
