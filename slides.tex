...
\begin{frame}{Automating Wannierization}
   ...
   \begin{columns}
      \begin{column}{0.5\textwidth}
         ...
         \begin{center}
            \only<1-3>{\includegraphics[height=0.6\paperheight]{figures/proj_disentanglement_fig1a.png}}
...
\begin{frame}{Automating Wannierization}
   ...
   \begin{itemize}
      ...
      \item they serve as our initial guesses for the Wannier functions \onslide<2->{$\rightarrow$ the number of Wannier functions is limited to the number of pseudoatomic orbitals}
   \end{itemize}

   \onslide<3->{This is a problem for some systems e.g. LiF}

   \onslide<4->{

      \begin{center}
         \begin{tabular}[h]{cccc}
            element         & electronic configuration                                                                                              & {PAOs}                                                              & {number of PAOs} \\
            \hline
            Li              & 1s\textsuperscript{2} 2s\textsuperscript{1}                                                                           & {1s, 2s}                                                            & {2}              \\
            {F} & {\textcolor{seaborn_bg_grey_darker}{[1s\textsuperscript{2}]} 2s\textsuperscript{2} 2p\textsuperscript{5}} & {2s, 2p\textsubscript{x}, 2p\textsubscript{y}, 2p\textsubscript{z}} & {4}
         \end{tabular}
      \end{center}
   }

   \vspace{1ex}
   \onslide<5->{6 Wannier functions for a system with 5 occupied bands}

   \vspace{1ex}
   \onslide<6->{If we want more Wannier functions, we're gonna need \sout{a bigger boat} more PAOs...}
